...
<div class="mb-3">
    <div class="btn-group d-flex">
        <a href="index.html" class="btn btn-quick-links mr-3 ql-active">
            <img src="{{ asset('assets/images/icons/theme/speech.png') }}" class="mr-2" alt="quick links icon">
            <span class="fs-8">Speech</span>
        </a>
        <a href="messages.html" class="btn btn-quick-links mr-3">
            <img src="{{ asset('assets/images/icons/theme/listen.png') }}" class="mr-2" alt="quick links icon">
            <span class="fs-8">Listen</span>
        </a>
        <a href="watch.html" class="btn btn-quick-links">
            <img src="{{ asset('assets/images/icons/theme/watch.png') }}" class="mr-2" alt="quick links icon">
            ...
            <div class="row post-form-group">
                <div class="col-md-9">
                    <button type="button" class="btn btn-link post-form-btn btn-sm">
                        <img src="{{ asset('assets/images/icons/theme/post-image.png') }}" alt="post form icon"> 
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    <ul class="media-list comments-list">
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img src="{{ asset('assets/images/posts/1758701351.jpg') }}" alt="" class="img-circle">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img src="{{ asset('assets/images/posts/post-1.jpg') }}" alt="" class="img-circle">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    <ul class="media-list comments-list">
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img src="{{ asset('assets/images/posts/generalhome.png') }}" alt="" class="img-circle">
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                                    <strong class="text-gray-dark"><a href="#" class="fs-8">Lia Earnest</a></strong>
