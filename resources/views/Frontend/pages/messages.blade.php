                                    ...
                                    <ul class="conversations">
                                        <li class="contact">
                                            <div class="wrap">
                                                ...
                                                <img src="{{asset('assets/images/users/user-5.png')}}" alt="Conversation user" />
                                        ...
                                        <li class="contact messenger-user-active">
                                            <div class="wrap">
                                                ...
                                                <img src="{{asset('assets/images/users/user-6.png')}}" alt="Conversation user" />
                                                <div class="meta">
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                ...
                                                <img src="{{asset('assets/images/users/user-7.png')}}" alt="Conversation user" />
                                                <div class="meta">
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                <span class="contact-status online"></span>
                                                <img src="{{asset('assets/images/users/user-8.png')}}" alt="Conversation user" />
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                <span class="contact-status busy"></span>
                                                <img src="{{asset('assets/images/users/user-9.png')}}" alt="Conversation user" />
                                                <div class="meta">
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                ...
                                                <img src="{{asset('assets/images/users/user-10.png')}}" alt="Conversation user" />
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                <span class="contact-status"></span>
                                                <img src="{{asset('assets/images/users/user-11.png')}}" alt="Conversation user" />
                                                <span class="unread-messages">1</span>
                                                <div class="meta">
                                        ...
                                        <li class="contact">
                                            <div class="wrap">
                                                <span class="contact-status busy"></span>
                                                <img src="{{asset('assets/images/users/user-12.png')}}" alt="Conversation user" />
                                    ...
                                    <div class="col-md-12 messenger-top-section">
                                        <div class="contact-profile d-flex align-items-center justify-content-between">
                                            <div class="messenger-top-luser df-aic">
                                                <img src="{{asset('assets/images/users/user-6.png')}}" class="messenger-user" alt="Convarsation user image" />
                                                <a href="#" class="message-profile-name">Susan P. Jarvis</a>
                                            </div>
                                            <div class="social-media messenger-top-ricon df-aic">
                                                <img src="{{asset('assets/images/icons/messenger/phone.png')}}" data-toggle="modal" data-target="#callModal" class="msg-top-more-info" alt="Messenger icons">
                                                <img src="{{asset('assets/images/icons/messenger/videocam.png')}}" class="msg-top-more-info" alt="Messenger icons">
                                                <img src="{{asset('assets/images/icons/messenger/info.png')}}" class="msg-top-more-info" alt="Messenger icons">
                                                <span class="dropdown">
                                        ...
                                        <div class="messages">
                                            <ul class="messages-content">
                                                <li class="message-receive">
                                                    <img src="{{asset('assets/images/users/user-6.png')}}" alt="Conversation user image" />
                                                ...
                                                <form class="d-inline form-inline">
                                                    <div class="d-flex align-items-center justify-content-between messenger-icons">
                                                        <button type="button" class="btn search-button">
                                                            <img src="{{asset('assets/images/icons/messenger/m-camera.png')}}" alt="Messenger icons">
                                                        </button>
                                                        <button type="button" class="btn search-button">
                                                            <img src="{{asset('assets/images/icons/messenger/m-photo.png')}}" alt="Messenger icons">
                                                        </button>
                                                        <button type="button" class="btn search-button">
                                                            <img src="{{asset('assets/images/icons/messenger/m-gamepad.png')}}" alt="Messenger icons">
                                                        </button>
                                                        <button type="button" class="btn search-button">
                                                            <img src="{{asset('assets/images/icons/messenger/m-microphone.png')}}" alt="Messenger icons">
                                                        </button>
                                                        <div class="input-group messenger-input">
                                                            ...
                                                            <div class="input-group-append">
                                                                <button class="btn search-button" type="button" id="button-addon2 send-message">
                                                                    <img src="{{asset('assets/images/icons/messenger/m-smile.png')}}" alt="Messenger icons">
                                                                </button>
                                                            </div>
                                                        </div>
                                                        <button type="button" class="btn search-button" id="send-message">
                                                            <img src="{{asset('assets/images/icons/messenger/m-send.png')}}" alt="Messenger icons">
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-center">
                            <div class="call-user text-center">
                                <div class="call-user-img-anim">
                                    <img src="{{asset('assets/images/users/user-1.jpg')}}" class="call-user-img" alt="Call user image">
                                </div>
